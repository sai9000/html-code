			...
			<table>
				<tr>
					...
					<div class="form-group">
						<label class="control-label col-sm-2" path="name" for="name"><font
							color="black">Product-Name:</font></label>
						<div class="col-sm-5">
				...
				<div class="form-group">
					<label class="control-label col-sm-2" path="description"
						for="description"><font color="black">Product-Description:</font></label>
					<div class="col-sm-5">
				...
				<div class="form-group">
					<label class="control-label col-sm-2" path="quantity"
						for="quantity"><font color="black">Product-Quantity:</font></label>
					<div class="col-sm-5">
						<input type="text" class="form-control" id="quantity"
							path="quantity"
							placeholder="Enter your Product Quantity here" required />
					</div>
				...
				<div class="form-group">
					<label class="control-label col-sm-2" path="price"
						for="quantity"><font color="black">Product-Price:</font></label>
					<div class="col-sm-5">
						<input type="text" class="form-control" id="price"
							path="price"
							placeholder="Enter your Product Price here" required />
					</div>
				...
				<div class="row">
					<div class="form-group col-md-12">
						<label class="col-md-3 control-lable" for="image">Product
							Picture: </label>
						<div class="col-md-7">
